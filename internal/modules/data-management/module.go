...
import (
	"zania-api/internal/modules/data-management/delivery/resthandler"
	"zania-api/internal/modules/data-management/delivery/workerhandler"
...
const (
	moduleName types.Module = "DataManagement"
)
